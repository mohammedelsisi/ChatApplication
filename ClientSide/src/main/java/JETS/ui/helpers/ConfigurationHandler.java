...
public class ConfigurationHandler {
    ...
    public void rememberMe(LoginEntity loginEntity) {
        ...
        try (OutputStream output = new BufferedOutputStream(new FileOutputStream("private/config.properties"))) {
    ...
    public LoginEntity getLoginEntity() {
        ...
        try (InputStream input = new FileInputStream(("private/config.properties"))) {
